...
const Updateschedule = () => {
  ...
  useEffect(() => {
    ...
    const fetchSchedule = async () => {
      try {
        const response = await axiosInstance.get(`${import.meta.env.VITE_API_BASE_URL}/doctors/schedule`, { params: { doctorEmail } });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axiosInstance.put(`${import.meta.env.VITE_API_BASE_URL}/doctors/update-schedule`, {
        doctorEmail,
